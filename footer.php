...
function footer(){
    ...
    echo'                    <h6 class="text-uppercase font-weight-bold">Información Adicional</h6>';
    ...
    echo'                    <br/>polications@gmail.com';
    echo'                </div>';
    echo'            </div>';
    echo'        </div>';

    echo'        <div class="footer-copyright text-center">2021 Proyecto de Aplicación e Innovación Tecnológica</div>';
    echo'    </footer>';
